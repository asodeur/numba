...
from numba import types, cgutils, typing, errors, config
...
def build_list(context, builder, list_type, items):
    ...
    for i, val in enumerate(items):
        inst.setitem(context.get_constant(types.intp, i), val, incref=not config.LOWER_CONSTANT_RETURNS_NEW_REFS)
